...
A base project is a sample standard project in which separation of concerns followed that contains separate layers for builds, assets, business logic, and other coding techniques in separate directories. This project explains how to keep everything intact that is needed in code in its place. All the coding techniques which are standard of Arhamsoft's MERN apps are enlisted in this base project.
